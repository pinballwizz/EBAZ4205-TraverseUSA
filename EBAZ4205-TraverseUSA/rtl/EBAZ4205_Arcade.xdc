...
set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS33 } [get_ports { joy[0] }]; # LT
set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 } [get_ports { joy[1] }]; # RT
set_property -dict { PACKAGE_PIN T19   IOSTANDARD LVCMOS33 } [get_ports { joy[2] }]; # UP
set_property -dict { PACKAGE_PIN T20   IOSTANDARD LVCMOS33 } [get_ports { joy[3] }]; # DN
set_property -dict { PACKAGE_PIN R19   IOSTANDARD LVCMOS33 } [get_ports { joy[4] }]; # B1
